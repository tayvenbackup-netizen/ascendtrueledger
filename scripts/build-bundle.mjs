...
const viewportFix = `
:root{--nav-side:10px;--nav-bottom:calc(env(safe-area-inset-bottom, 0px) + 32px);--nav-height:86px;--sat:env(safe-area-inset-top, 0px);--sab:env(safe-area-inset-bottom, 0px);--app-bg:#000000;}
